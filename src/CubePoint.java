...
public class CubePoint {
	...
	public void rotateX(double a, CubePoint axis) {
		a *= Math.PI / 180;
		double[][] matrix = { { 1.0, 0.0, 0.0 }, { 0.0, Math.cos(a), -Math.sin(a) },
	...
	public void rotateY(double a, CubePoint axis) {
		a *= Math.PI / 180;
		double[][] matrix = { { Math.cos(a), 0.0, Math.sin(a) }, { 0.0, 1.0, 0.0 },
	...
	public void rotateZ(double a, CubePoint axis) {
		a *= Math.PI / 180;
		double[][] matrix = { { Math.cos(a), -Math.sin(a), 0.0 }, { Math.sin(a), Math.cos(a), 0.0 },
				{ 0.0, 0.0, 1.0 } };
		x -= axis.x;
		y -= axis.y;
		z -= axis.z;
